...
function Restuarant(props) {
    ...
    // let arr = ['Muthe Gowda', 'Rekha', 'Yamuna'];
                ...
                <h1>Food Menu</h1>
             {
                ...
                menuData.foodData.map(item => {
                    return <li key={item.foodName}>
                        Food Name is {item.foodName}, Price: {item.price}, Catagory: {item.catogory}
                    </li>
                }) : <h1>Loading</h1>
            }
                <h1>Drink Menu</h1>
             {
                ...
                menuData.drinkData.map(item => {
                    return <li key={item.drinkName}>
                        Drink Name is {item.drinkName}, Price: {item.price}, Catagory: {item.catogory}
                    </li>
                }): <h1>Loading</h1>
            }
            </div>
